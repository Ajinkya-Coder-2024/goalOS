		...
		extend: {
			colors: {
				...
				challenge: {
					...
					foreground: 'hsl(var(--challenge-foreground))',
					subtle: 'hsl(var(--challenge-subtle))'
				},
				'life-plan': {
					DEFAULT: 'hsl(var(--life-plan))',
					foreground: 'hsl(var(--life-plan-foreground))',
					subtle: 'hsl(var(--life-plan-subtle))'
				},
				study: {
					DEFAULT: 'hsl(var(--study))',
					foreground: 'hsl(var(--study-foreground))',
					subtle: 'hsl(var(--study-subtle))'
				},
				project: {
					DEFAULT: 'hsl(var(--project))',
					foreground: 'hsl(var(--project-foreground))',
					subtle: 'hsl(var(--project-subtle))'
				},
				sidebar: {
